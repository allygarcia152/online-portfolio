...
function About() {
  return (
    <section className="flex flex-col md:mt-5 md:ml-5 border border-dark rounded self-start md:max-w-screen-md sm:max-w-screen sm:min-h-80 md:max-h-full sm:m-2">
      ...
      <div className="sm:block md:flex-row md:flex-wrap sm:p-4 md:p-6 bg-light rounded-bottom">
        <img
